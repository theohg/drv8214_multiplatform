...
> 🦶 **Featured in [Plume](https://github.com/theohg/Plume)** — a smart diabetic insole that drives up to 18 sensorless brushed-DC motors via ripple counting to redistribute plantar pressure. This library powers its motor control.
